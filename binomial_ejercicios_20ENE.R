...
x<- 0
for (i in 1:13) {
  if (salon_binomial[4, i+1] != salon_binomial[5, i+1]){
    x <- x+1
  }
}
...
mat1
vec1 <- c()
vec1 ##hacer uno por uno de los vectores, despues unirlos en una matriz, 
...
#f1
formula1 <- probabilidad_formula(5,5,5/22)
formula1

#anime
anime <- probabilidad_formula (10, 4, 12/22)
anime
